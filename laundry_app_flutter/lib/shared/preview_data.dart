...
class PreviewService {
  ...
  // Unit is authoritative, including records with legacy group labels.
  String get effectiveGroup =>
      unit.trim().toUpperCase() == 'KG' ? 'Kiloan' : 'Satuan';
...
class PreviewDataController extends Notifier<PreviewDataState> {
  ...
  static final _defaultServices = _defaultServiceCatalog;
  @override
  ...
  void addService({
    ...
    final service = PreviewService(
      id: _uuid.v4(),
      name: variant.isEmpty ? trimmedItemName : '$trimmedItemName $variant',
