...
values ('00000000-0000-0000-0000-000000000001', 'Idola Laundry', '0812-2000-3075', '')
...
insert into _idola_service_catalog (
  ...
  ('service-cs-reguler', '93217695-2055-491a-89b8-d95d01860df0', 'Cuci Setrika', 'Cuci Setrika', 'Reguler', 'KG', 7000, 72, false, 10),
  ('service-cs-express', '9c6ac991-df8d-41cd-a1da-5b042964d1b3', 'Cuci Setrika', 'Cuci Setrika', 'Express', 'KG', 9000, 24, true, 11),
  ('service-cs-kilat', 'f113a359-7bb1-42ee-9b98-202818e2b01a', 'Cuci Setrika', 'Cuci Setrika', 'Kilat', 'KG', 12000, 8, true, 12),
  ('service-ckl-reguler', '2398b203-82e2-4048-8ec9-c6b8be10640b', 'Cuci Kering Lipat', 'Cuci Kering Lipat', 'Reguler', 'KG', 4000, 72, false, 20),
  ('service-ckl-express', '9ab0b172-e3fd-42f1-8ec5-8dbb9b365633', 'Cuci Kering Lipat', 'Cuci Kering Lipat', 'Express', 'KG', 6000, 24, true, 21),
  ('service-ckl-kilat', 'a9ef1065-875a-4e2e-b79e-2bdf315ff005', 'Cuci Kering Lipat', 'Cuci Kering Lipat', 'Kilat', 'KG', 9000, 8, true, 22),
  ('service-sl-reguler', 'f5d9a779-59bf-40d8-b5f6-2023c690af20', 'Setrika Lipat', 'Setrika Lipat', 'Reguler', 'KG', 5000, 72, false, 30),
  ('service-sl-express', '128536d1-851d-4480-bd5d-fe136c27dbaf', 'Setrika Lipat', 'Setrika Lipat', 'Express', 'KG', 7000, 24, true, 31),
  ('service-sl-kilat', '15da8690-dad5-46f9-a346-8ee16003b82d', 'Setrika Lipat', 'Setrika Lipat', 'Kilat', 'KG', 10000, 8, true, 32),
